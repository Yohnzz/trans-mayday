...
<h1>TRANS PAYROLL</h1>
<div class="subtitle">Sistem hitung gaji duty • otomatis • rapi</div>
...
Gaji Jabatan : ${data.gaji_jabatan.toLocaleString('id-ID')}
Gaji Jam : ${data.gaji_jam.toLocaleString('id-ID')}
